...
예를 들어 글 중간에 아래와 같은 수식이나 순서도 삽입이 가능합니다.
...
이외에도 마크다운으로 작성한 글 파일을 기본적으로 내 저장소에 물리적으로 보유할 수 있기 때문에, 조금만 다듬는다면 예를 들어 옵시디언과 같이 마크다운을 지원하는 프로그램과도 문제없이 호환할 수 있다는 장점도 있습니다.
