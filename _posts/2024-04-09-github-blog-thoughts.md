...
위 기능들은 공통적으로 블로그를 운영하면서 놓치기 쉬운 부분이지만, 잘 활용한다면 블로그가 쓰는 이와 읽는 이 모두에게 제공하는 전반적인 경험의 질을 올릴 수 있습니다. 잘만 활용한다면 이미지를 불러오는 도중의 순간을 부드럽게 처리한다거나, 모바일 기기에 내 블로그 전용 어플을 설치한다거나 하는등의 경험이 가능해요.
