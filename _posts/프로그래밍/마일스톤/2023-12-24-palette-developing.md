---
title: "모바일 슈팅 게임 개발하기: 후기 개발과 스토어 등록 과정"
...
image:
    path: /img/2023-12-13-palette-developing/gameplay.gif
...
![flare](/img/2023-12-13-palette-developing/flare.gif){: w="960" }
![flare-animation](/img/2023-12-13-palette-developing/flare-animation.png){: w="960" }
```cs
...
![flare-clipstudio](/img/2023-12-13-palette-developing/flare-clipstudio.png){: w="480" }
![flare-images](/img/2023-12-13-palette-developing/flare-images.png){: w="480" }
...
![gained-animation](/img/2023-12-13-palette-developing/gained-animation.gif){: w="960" }
<!--코드-->
...
![hit-particle](/img/2023-12-13-palette-developing/hit-particle.gif){: w="960" }
![particle-graph](/img/2023-12-13-palette-developing/particle-graph.gif){: w="960" }
```cs
public void Hit()
{
...
![pistol-reload](/img/2023-12-13-palette-developing/pistol-reload.gif){: w="960" }
![pistol-animation](/img/2023-12-13-palette-developing/pistol-animation.png){: w="960" }
```cs
...
![damage-effect](/img/2023-12-13-palette-developing/damage-effect.gif){: w="960" }
![damage-effect-animation](/img/2023-12-13-palette-developing/damage-effect-animation.png){: w="960" }
...
![player-moving](/img/2023-12-13-palette-developing/player-moving.gif){: w="960" }
![player-animation](/img/2023-12-13-palette-developing/player-animation.png){: w="960" }
...
![exp-bar](/img/2023-12-13-palette-developing/exp-bar.gif){: w="960" }
![exp-bar-animation](/img/2023-12-13-palette-developing/exp-bar-animation.png){: w="960" }
...
![game-enter](/img/2023-12-13-palette-developing/game-enter.gif){: w="960" }
...
![object-design](/img/2023-12-13-palette-developing/object-design.png){: w="960" }
_갤럭시 탭으로 그림_
...
저는 평소 취미로서 **[사진을 찍거나](https://hynrng.github.io/posts/photos-of-imin/)** **[그림을 그리곤](https://hynrng.github.io/posts/third-drawings/)** 하는데요, 이 두 취미를 교차검증하면서 이 두 분야와 같이 2차원 형식을 공유하는 표현물에서는 적절한 화각(FOV)의 선택을 통해 화상 왜곡 효과와 함께 더 많이, 혹은 더 적게 보여줌으로서 생각보다 많은 것을 표현할 수 있음을 알게 되었습니다.

유니티의 2D환경은 정사영(Orthographic) 방식으로 씬을 보여주므로 개념에는 차이가 있지만 얼마나 더 넓게 담을지에 대한 추상적인 관점에서는 2D에서도 고민할 부분이 있다고 생각했어요.

<div class="row">
    <div class="col-md-6">
        <img src="/img/2023-12-13-palette-developing/pistol-reload.gif" alt="pistol-reload">
    </div>
    <div class="col-md-6">
        <img src="/img/2023-12-13-palette-developing/game-enter-cropped.gif" alt="game-enter-cropped">
    </div>
</div>
...
![audacity](/img/2023-12-13-palette-developing/audacity.png){: .light .border }
![audacity](/img/2023-12-13-palette-developing/audacity.png){: .dark }
_크리티컬 효과음_
...
![iaa](/img/2023-12-13-palette-developing/iaa.gif){: w="960" }
```cs
void PlayerDied()
{
    ShowInterstitialAd();
...
![iap](/img/2023-12-13-palette-developing/iap.png){: .light .border }
![iap](/img/2023-12-13-palette-developing/iap.png){: .dark w="960" }
```cs
void Purchase()
{
...
![logo](/img/2023-12-13-palette-developing/logo.png){: .light .border w="240" }
![logo](/img/2023-12-13-palette-developing/logo.png){: .dark w="240" }
_어플 로고_
...
![google-play-console](/img/2023-12-13-palette-developing/google-play-console.png){: .light .border w="960" }
![google-play-console](/img/2023-12-13-palette-developing/google-play-console.png){: .dark w="960" }
...
![play-store](/img/2023-12-13-palette-developing/play-store.png){: .light .border w="960" }
![play-store](/img/2023-12-13-palette-developing/play-store.png){: .dark w="960" }
...
![reddit-light](/img/2023-12-13-palette-developing/reddit-light.png){: .light .border w="960" }
![reddit-dark](/img/2023-12-13-palette-developing/reddit-dark.png){: .dark w="960" }
...
![reddit-feedback-light](/img/2023-12-13-palette-developing/reddit-feedback-light.png){: .light .border w="960" }
![reddit-feedback-dark](/img/2023-12-13-palette-developing/reddit-feedback-dark.png){: .dark w="960" }
...
<!--
![notion-light](/img/2023-12-13-palette-developing/notion-light.png){: .light .border }
![notion-dark](/img/2023-12-13-palette-developing/notion-dark.png){: .dark }
