...
![astp-performance-light](/2022-12-28-astp/astp-performance-light.png){: .light .border }
![astp-performance-dark](/2022-12-28-astp/astp-performance-dark.png){: .dark .shadow }
_프로그램 예시 동작 화면(상), 프로그램 통해 애플 1주를 매수한 화면(하)_

UI를 구성하지 않은 단순한 파이썬 프로그램이기 때문에 명령 프롬프트에서 실행됩니다. 매수주문이 체결되 프롬프트 창으로도 결과를 확인할 수 있지만, 아래의 캡처된 화면과 같이 한국투자증권 어플을 통해서도 매수 여부 및 보유중인 주식 상황을 확인할 수 있습니다.
